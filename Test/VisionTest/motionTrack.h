...
void detectObject(Mat *frame, vector<Vec3f> circles, vector<vector<Point> > contours, Point2f *center, float *radius, int bias, int radialBias);
void detectDirection(Mat *frame, deque <Point2f> points, int pt_size, string *direction, int x, int y);
#endif
